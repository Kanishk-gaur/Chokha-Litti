...
export default function HeroSection() {
  ...
  const featuredItems = [
    ...
    },
    {
      ...
      description:
        "Smoky roasted eggplant mash with aromatic spices and fresh herbs",
      price: "₹49",
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <span className="block mt-2 md:mt-3 text-3xl md:text-4xl font-medium">
              A Taste of Bihar&apos;s Heritage
            </span>
          </motion.h1>
          ...
          >
            Experience the rustic flavors and traditional recipes perfected over
            generations
          </motion.p>
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center">
            ...
            >
              <button className="inline-flex items-center bg-white/10 hover:bg-white/20 border border-amber-300/50 text-white px-8 py-4 rounded-xl font-medium transition-all hover:border-amber-300">
                Order Now
                <svg
                  className={`ml-2 h-5 w-5 transition-transform ${
                    showOrderOptions ? "rotate-180" : ""
                  }`}
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
              ...
              <AnimatePresence>
                {showOrderOptions && (
                  <motion.div
                    ...
                    style={{ zIndex: 9999 }}
                    className="fixed sm:absolute z-[9999] mt-3 w-64 left-1/2 transform -translate-x-1/2 sm:left-0 sm:translate-x-0 origin-top rounded-lg bg-white shadow-xl border border-amber-100"
                  >
                    <div className="p-1 space-y-0.5">
                      ...
                      <a
                        ...
                        className="flex items-center px-3 py-2 text-sm text-gray-800 hover:bg-amber-50 rounded-md transition-colors"
                      >
                        <div className="bg-red-500 w-7 h-7 rounded-full flex items-center justify-center mr-2">
                          {" "}
                          {/* Reduced icon size */}
                          <Image
                      ...
                      <a
                        ...
                        className="flex items-center px-3 py-2 text-sm text-gray-800 hover:bg-amber-50 rounded-md transition-colors"
                      >
                        <div className="bg-orange-500 w-7 h-7 rounded-full flex items-center justify-center mr-2">
                          <Image
                      ...
                      <a
                        ...
                        className="flex items-center px-3 py-2 text-sm text-gray-800 hover:bg-amber-50 rounded-md transition-colors"
                      >
                        <div className="bg-green-500 w-7 h-7 rounded-full flex items-center justify-center mr-2">
                          <Image
                        ...
                        <div>
                          ...
                          <div className="text-xs text-gray-500">
                            Direct message for orders
                          </div>
                        </div>
                      </a>
                    </div>
                    <div className="px-3 py-1.5 bg-amber-50 text-xs text-amber-800 rounded-b-lg">
                      {" "}
                      {/* Reduced padding */}
                      Use code <span className="font-bold">FIRSTBITE</span> for
                      15% off
                    </div>
                  </motion.div>
                )}
          ...
          >
            <div className="flex -space-x-2">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="w-8 h-8 rounded-full bg-amber-600 border-2 border-amber-800 flex items-center justify-center text-xs text-white"
                >
                  {i}
                </div>
              ))}
            ...
            <div className="ml-3 text-amber-200 text-sm">
              <span className="font-bold">4.8/5</span> based on{" "}
