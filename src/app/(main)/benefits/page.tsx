  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-amber-50 to-orange-50 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5 z-0">
        <Image
          src="/Cow.jpg" // Replace with your cow image or pattern
          alt="Cow background"
          fill
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl md:text-2xl text-orange-700 mb-10 max-w-3xl mx-auto">
              Order now and experience the traditional flavors of Bihar
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <motion.button
                ...
                className="px-10 py-4 bg-gradient-to-r from-amber-600 to-orange-600 text-white text-lg font-semibold rounded-full shadow-lg hover:shadow-xl transition-all group relative overflow-hidden"
              >
                <span className="absolute inset-0 w-full h-full bg-gradient-to-r from-amber-700 to-orange-700 opacity-0 group-hover:opacity-100 transition-opacity"></span>
              ...
              <motion.button
                ...
                className="px-10 py-4 bg-white text-amber-700 border-2 border-amber-300 text-lg font-semibold rounded-full shadow-lg transition-all hover:bg-amber-50 hover:border-amber-400"
              >
